          ...
          <div class="row">
            ...
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    <input type="tel" class="form-control" name="no_telp" id="no_telp" placeholder="Nomer Handphone" required>
                </div>
            </div>
            <div class="col-12 col-md-6">
                <div class="form-group">
          ...
          <div class="row">
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="no_domisili" id="no_domisili" placeholder="no domisili" required>
                </div>
            </div>
            <div class="col-12 col-md-6">
                <div class="form-group">
                    <label for="nama_domisili">Nama Domisili</label>
                    <input type="text" class="form-control" name="nama_domisili" id="nama_domisili" placeholder="nama domisili" required>
                </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="province_domisili" id="province_domisili" placeholder="Provinsi domisili" required>
                </div>
            </div>
            <div class="col-12 col-md-6">
                <div class="form-group">
                    <label for="kota_domisili">Kota Domisili</label>
                    <input type="text" class="form-control" name="kota_domisili" id="kota_domisili" placeholder="kota domisili" required>
                </div>
            </div>
          </div>
          <div class="row">
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="no_npwp" id="no_npwp" placeholder="Nomer NPWP" required>
                </div>
            </div>
            <div class="col-12 col-md-6">
                <div class="form-group">
                    <label for="nama_npwp">Nama NPWP</label>
                    <input type="text" class="form-control" name="nama_npwp" id="nama_npwp" placeholder="nama NPWP" required>
                </div>
            </div>
            <div class="col-12">
                <div class="form-group">
